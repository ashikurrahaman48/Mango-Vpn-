...
// Protect all user management routes, only allowing admins to access them.
// Fix: The protect middleware expects a MethodRoles object, not an array of roles. Also corrected 'admin' to 'administrator'.
